function Ball(radius, color) {
  ...
  this.loopRadius = utils.getRandomArbitrary(5, 10);
  this.loopSpeed = Math.random() * 0.15 * ((utils.coinFlip()) ? 1 : -1);
  this.loopAngle = Math.random() * 10;

  this.scaleAngle = Math.random() * 2 * Math.PI;
  this.centerScale = 1;
  this.rangeScale = 1.75;
  this.scaleSpeed = utils.getRandomArbitrary(0.05, 0.09);
