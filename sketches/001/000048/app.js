(function() {
  document.addEventListener('DOMContentLoaded', function() {
    ...
    function drawFrame() {
      ...
      var fontString = canvas.height / 9 + "px helvetica";
      ctx.font = fontString;

      var string = 'i dream of journeys repeatedly';

      var text = ctx.measureText(string); // TextMetrics object

      ctx.fillStyle = "rgba(255, 255, 255, 0.15)";
      ctx.fillText(string, canvas.width / 2 - text.width / 2, canvas.height / 2 + 10);
    }
