(function() {
  document.addEventListener('DOMContentLoaded', function() {
    ...
    var balls = [];
    var numBalls = utils.getRandomArbitrary(2, 5);

    for (var i = 0; i < numBalls; i++) {
      balls[i] = new Ball(utils.getRandomArbitrary(10, 20), "rgba(0, 120, 220, 0.05)");
    }
    ...
    function drawFrame() {
      ...
      ctx.save();
      ctx.lineWidth = 2;
      ctx.strokeStyle = "#08080815";
      ctx.fillStyle = "#00888808";
      ctx.beginPath();
